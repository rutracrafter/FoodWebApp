...
function searchEnter(event) {
  if (event.key === "Enter") {
    ...
    // let apiUrl = "https://api.spoonacular.com/recipes/complexSearch?apiKey=ac8f41702dc6488f85d3dda5ccc52208&instructionsRequired=true&addRecipeInformation=true&number=6&offset=0";
    // if (searchField != "") {
